...
def download_attendance(request):
    ...
    if request.method == 'POST':
        ...
        headers = ['Name', 'Email', 'PRN', 'Contact No.', 'Division', 'No. of Sessions Attended', 'Attendance Percentage', 'Report Marks', 'Data Collection Marks', 'Certificate Sent?', 'Roll Number'] # If using older codes, remove 5th & 6th fields of headers list
        ...
        for volunteer in volunteers:
            ...
            if volunteer.certificateSent:
                sheet.cell(row=row_num, column=10, value="Yes")
            else:
                sheet.cell(row=row_num, column=10, value="No")
            sheet.cell(row=row_num, column=11, value=volunteer.roll)
