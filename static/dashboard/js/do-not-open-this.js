...
setTimeout(() => {
  if (!blurred) {
    errorAudio.play()
    alert("🚨 Oops! We have found some extensions that prevent getting detected when you change tabs. Please uninstall those extensions and enable popups then come back to report filling..");
