...
DIVISIONS = {
    ...
    "Muskaan": ["CSAIML-C", "CSAIDS-F", "CSAI-D"],
    "Udaan": ["ET-B", "ME-C"],
    "Saksham": ["CSDS-B"],
    "Aashakiran": ["ET-C", "CV-A"],
    "Aavishkar": ["CSAIDS-A", "CSAIDS-B"],
    "Vatsalya": ["CSAIDS-D"],
    "Aadhar": ["CSAIML-A", "CSAIML-E"],
    "Swaccha Pune": ["CS-E", "CS-F", "CS-G", "CS-H", "IC-A", "IC-B", "IC-C"],
    "Go Green": ["CSAI-C", "ME-A", "ME-B", "CSAIDS-C", "ME-E", "ET-A", "ET-D", "CSAIML-B", "CSAIML-F", "CSAI-E", "CSAI-F", "ET-E", "CSAI-B"],
    "Night Patrolling": ["ET-B", "ME-C"],
    "Jagruti": ["ME-F", "ET-F"],
    "Spandan": ["CSAIDS-E", "CSAI-A", "ME-D", "CSAIML-D"]
}
